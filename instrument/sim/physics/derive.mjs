...
import { generateSpectrum, scanMetaForMode } from "./spectrum.mjs?v=component-overlay-20260611";
...
import { SAMPLE_PROFILES } from "../state.mjs?v=component-overlay-20260611";
